...
func StrJoin(s []string, sep string) string { return strings.Join(s, sep) }
...
func Str2Lower(s string) string             { return strings.ToLower(s) }
func Str2Upper(s string) string             { return strings.ToUpper(s) }
